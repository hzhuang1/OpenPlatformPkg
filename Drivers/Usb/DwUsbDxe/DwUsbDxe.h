...
#define GUSBCFG_PHY_8BIT                (0x9 << 10)
#define GUSBCFG_PHY_16BIT               (0x5 << 10)
...
#define DXEPMSK_AHB_ERR                 (1 << 2)
#define DXEPMSK_XFER_DONE               (1 << 0)
...
#define DOEPTSIZ0_SUPCNT(x)             (((x) & 3) << 29)
#define DOEPTSIZ0_PKTCNT                (1 << 19)
#define DOEPTSIZ0_XFERSIZE(x)           ((x) & 0x7F)
...
#define DXEPCTL_EPTYPE(x)               (((x) << 18) & DXEPCTL_EPTYPE_MASK)
#define DXEPCTL_NAKSTS                  (1 << 17)
#define DXEPCTL_USBACTEP                (1 << 15)
#define DXEPCTL_NEXTEP(x)               ((x) << 11)
#define DXEPCTL_MPS_MASK                (0x3FF)
...
typedef struct {
	...
	DEV_DMA_DESC_STS status;
	/* DMA Descriptor data buffer pointer */
	UINT32 buf;
} DWC_OTG_DEV_DMA_DESC;
